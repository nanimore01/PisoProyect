...
public class StaminaSystem : MonoBehaviour
{
    ...
    [SerializeField] float timeToRecharge = 100f;
    ...
    void SendNotification()
    {
        ...
        notifId = NotificationManager.Instance.CreateNotification("Ya ten�s toda la Stamina", "Pod�s volver a jugar", timeToSend);
    }
}
